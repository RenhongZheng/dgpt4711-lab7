...
class Place {
    ...
    protected $data = [
        '1' => [
            ...
            'link' => 'To implement the system of farming land;Unify the central Plains and the north;Lay the foundation of the cao Wei regime.',
            'image' => 'caochao.jpg',
        ],
        '2' => [
            'id' => 2,
            ...
            'link' => 'The battle of Puyang repelled Lu Bu and Wan Cheng to resist Zhang Xiu.',
            'image' => 'dianwei.jpg',
        ],
        '3' => [
            'id' => 3,
            ...
            'link' => 'Capture two chuan, establish Shu Han, against Cao Cao.',
            'image' => 'liubei.jpg',
        ],
        '4' => [
            'id' => 4,
            ...
            'link' => 'Two help young Lord, sweep Xichuan, Hanshui war.',
            'image' => 'zhaoziyun.jpg',
        ],
        '5' => [
            'id' => 5,
            ...
            'link' => 'Unified Hebei and became the strongest vassal at the end of the Han Dynasty.Hebei government wide, the people of virtue.',
            'image' => 'yuanshao.jpg',
        ],
        '6' => [
            'id' => 6,
            ...
            'link' => 'Assisted Sun Ce in subduing Jiangdong, defeated Cao Cao in Chibi, defeated Cao Ren in Nanjun, and put forward the plan of conquering Yizhou.',
            'image' => 'zhouyu.jpg',
        ],
    ];
